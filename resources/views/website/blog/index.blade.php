          ...
          <div class="row">
              ...
              <div class="col-md-6">
                  <div class="post">
                      <div class="post-thumb">
                          <a href="blog-single.html">
                              <img class="img-fluid" src="{{ asset('assets/website/images/blog/blog-post-2.jpg') }}" alt="">
                          </a>
                      </div>
              ...
              <div class="col-md-6">
                  <div class="post">
                      <div class="post-thumb">
                          <a href="blog-single.html">
                              <img class="img-fluid" src="{{ asset('assets/website/images/blog/blog-post-3.jpg') }}" alt="">
                          </a>
                      </div>
              ...
              <div class="col-md-6">
                  <div class="post">
                      <div class="post-thumb">
                          <a href="blog-single.html">
                              <img class="img-fluid" src="{{ asset('assets/website/images/blog/blog-post-4.jpg') }}" alt="">
                          </a>
                      </div>
